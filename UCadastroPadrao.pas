...
begin
 if lblValorCodigo.Caption = '' then   
     MessageDlg('Selecione um registro para que a alteração possa ser realizada!', mtInformation,[mbOK],0)
 else
...
begin
  if lblValorCodigo.Caption <> '' then
    ...
    begin
      MessageDlg('Selecione um registro para que a exclusão possa ser realizada!', mtInformation,[mbOK],0);        
      Abort;
    end;
end;
